...
@section('content')
    <main class="min-h-screen bg-gray-900 text-white flex items-center justify-center">
        ...
        <a href="{{route('sales.carts.archive')}}" class="fixed top-12 left-4"> <!-- index -->
        ...
        <section class="w-full h-screen flex items-center justify-center">
            ...
            <div class="bg-gray-800 p-8 rounded-lg text-center">
                <div class="text-4xl font-semibold mb-4">Bought By: {{$cart->user->name}}</div>
                <div>
                </div>
                <p class="text-gray-400">Price : {{$cart->total_fee_after_off}}</p>
                <p class="text-gray-400">Paid Date: {{$cart->paid_date}}</p>
