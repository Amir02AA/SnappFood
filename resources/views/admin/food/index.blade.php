...
@section('content')
    <main class="bg-blue-200 mx-auto flex min-h-screen w-full items-center justify-center text-white">
        ...
        <a href="{{route('admin.food.create')}}" class="fixed top-4 right-4"> <!-- Add -->
        ...
        <section class="flex w-[30rem] flex-col space-y-6">
            <div class="text-center text-4xl font-medium text-black">Food Categories</div>
                ...
                @foreach($food as $tier)
                    <div class="bg-gray-800 rounded-lg p-4 flex items-center justify-between">
                        ...
                        <div class="flex flex-row items-center justify-between gap-2">
                            ...
                            <a href="{{route('admin.food.edit',['food' => $tier])}}"
